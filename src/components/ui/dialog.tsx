  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-50%
        data-[state=closed]:slide-out-to-top-48%
        data-[state=open]:slide-in-from-left-50%
        data-[state=open]:slide-in-from-top-48% fixed top-[50%] left-[50%] z-50
    ...
    >
      ...
      <DialogPrimitive.Close
        className="ring-offset-background focus:ring-ring
          ...
          absolute top-4 left-4 rounded-sm text-black opacity-70
